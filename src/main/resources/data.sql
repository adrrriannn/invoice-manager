...
--Invoice Items
INSERT INTO invoice_item(id, description, amount, invoice_id)
VALUES (1, 'This is one item', 123.00, 1);

INSERT INTO invoice_item(id, description, amount, invoice_id)
VALUES (2, 'This is another item', 453.00, 1);

INSERT INTO invoice_item(id, description, amount, invoice_id)
VALUES (3, 'This is a third item', 288.00, 1);

INSERT INTO invoice_item(id, description, amount, invoice_id)
VALUES (4, 'This is fourth item', 111.00, 2);
